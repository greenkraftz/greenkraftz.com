...
if(isset($mobile_num )) {
    ...
    if(mysqli_num_rows($query) == 1) {
        ...
        VALUES ('chicken2home' ,'{$user_id}' ,'{$mobile_num}' , '{$user_name}' , '{$user_email}' , '{$feedback}', '{$rating}'  )");

    confirm($query1);

    //$data= "Chicken2Home Confirmation: Feedback Recieved.";
  ...
  $msg = wordwrap($msg,70);
    mail("water2home.chennai@gmail.com","Chicken2Home Feedback ". last_id(),$msg);
    mail("greenkraftz@gmail.com","Chicken2Home Feedback " .last_id(),$msg);

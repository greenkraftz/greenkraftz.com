...
if(isset($mobile_num)) {
    ...
    if(mysqli_num_rows($queryUser) == 1) {
        ...
        $queryorder= query("INSERT INTO chicken_orders (user_id, mobile_num, user_name, delivery_address, pincode) 
 ...
 foreach ($itemsArray as $key => $value) {
    ...
    $cartQuantity =  $value["quantity"];
      ...
      $queryItem= query("SELECT * FROM chicken_products WHERE pid = '{$itemid}' ");
       confirm($queryItem);
    ...
    $query1 = query("INSERT INTO chicken_order_list (order_id , mobile_num , p_id , p_name , p_price , p_quantity ,
     p_total ) 
   ...
   $data= "Chicken2Home Confirmation: Order is Successfully Placed.";
